                    ...
                    <form action="{{ route('products.update', $product) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-0">
                                ...
                                <div class="selectgroup selectgroup-pills">
                                    ...
                                    <label class="selectgroup-item">
                                        ...
                                        <span class="selectgroup-button">Archive</span>
                                    </label>
                                </div>
                            </div>
                            ...
                            {{-- <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="file" class="form-control" name= "image" id="image" value="image" @error('image') is-invalid @enderror> @if ($product->image)
                                </div>
                            </div> --}}
                            <div class="form-group">
